...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("XuaZ") then
			makefolder("XuaZ")
		end
		if not isfolder("XuaZ/BloxFruit") then
			makefolder("XuaZ/BloxFruit/")
		end
		if not isfile("XuaZ/BloxFruit/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("XuaZ/BloxFruit/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("XuaZ/BloxFruit/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("XuaZ/BloxFruit/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("XuaZ/BloxFruit/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
-- Orion Library setup with Fluent UI design
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/shlexware/Orion/main/source"))()

-- Main UI Window with Fluent styling
local Window = OrionLib:MakeWindow({
    Name = "Auto Farm | Fluent UI",
    HidePremium = false,
    SaveConfig = true,
    IntroEnabled = true,
    IntroText = "Starting...",
    ConfigFolder = "AutoFarmConfigFluent",
    Icon = "rbxassetid://4483345998" -- Rounded, minimalist icon
})

-- Auto Farm Tab setup with Fluent design
...
-- Toggle with Fluent animation and style
...
AutoFarmTab:AddToggle({
   ...
   AutoFarmTab:AddDropdown({
	...
	Default = "Normal",
	Options = {"Fast Attack", "Normal", "Slow"},
	Callback = function(Value)
...
-- Reset button with Fluent styling
